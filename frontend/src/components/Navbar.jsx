    ...
    <>
      <nav style={styles.nav}>
        ...
        <div style={styles.desktopLinks}>
          ...
          {showInstallBtn && (
            <button onClick={handleInstallClick} style={styles.installBtnDesktop}>
              📲 Install App
            </button>
          )}
        </div>
      ...
      {menuOpen && (
        <div style={styles.mobileMenu}>
          {/* Mobile Install Button - Prominent at the top */}
          {showInstallBtn && (
            <button onClick={handleInstallClick} style={styles.installBtnMobile}>
              <span style={{ fontSize: '1.2rem' }}>📲</span>
              <div style={{ textAlign: 'left' }}>
                <div style={{ fontWeight: '700', fontSize: '0.9rem' }}>Install SmartSOS</div>
                <div style={{ fontSize: '0.7rem', opacity: 0.9 }}>Access safety tools instantly from your home screen</div>
              </div>
            </button>
          )}
          ...
          {navLinks.map((link) => (
            ...
            >
              ...
              <span>{link.label}</span>
              {location.pathname === link.path && <span style={styles.mobileActiveBadge}>●</span>}
            </Link>
          ))}
...
const styles = {
  ...
  // New Desktop Install Button Style
  installBtnDesktop: {
    background: '#232d45',
    color: '#fff',
    border: 'none',
    ...
    boxShadow: '0 4px 10px rgba(35,45,69,0.2)',
  },
  ...
  logoutBtn: {
    ...
    fontWeight: '600',
    cursor: 'pointer',
    boxShadow: '0 2px 8px rgba(255,45,45,0.3)',
    whiteSpace: 'nowrap',
    border: 'none',
  },
  ...
  // New Mobile Install Button Style
  installBtnMobile: {
    background: '#232d45',
    color: '#fff',
    padding: '12px 16px',
    ...
    cursor: 'pointer',
    marginBottom: '0.8rem',
    boxShadow: '0 4px 15px rgba(35,45,69,0.2)',
  },
